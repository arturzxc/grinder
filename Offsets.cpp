...
constexpr long OFF_LEVEL = 0x168F670;                         //[Miscellaneous]->LevelName
constexpr long OFF_LOCAL_PLAYER = 0x2118848;                  //[Miscellaneous]->LocalPlayer
constexpr long OFF_ENTITY_LIST = 0x1d6a5d8;                   //[Miscellaneous]->cl_entitylist

//buttons
constexpr long OFF_IN_ATTACK = 0x7382AF0;                     //[Buttons]->in_attack
constexpr long OFF_IN_JUMP = 0x7382BF0;                       //[Buttons]->in_jump
...
constexpr long OFF_GLOW_HIGHLIGHTS = 0xB5C4090;               //[?]->?
